...
export class CodeVerifier {
    ...
    constructor() {
        this.form = document.getElementById('verifyForm') as HTMLFormElement;
        this.input = document.getElementById('verifyCodeInput') as HTMLInputElement;
        this.button = document.getElementById('verifyBtn') as HTMLButtonElement;
